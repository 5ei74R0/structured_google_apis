...
class CreateNamedRangeRequest(BaseModel):
    ...
    range: Optional[Range] = Field(description="The range to apply the name to.")
...
class DeleteParagraphBulletsRequest(BaseModel):
    ...
    range: Optional[Range] = Field(description="The range to delete bullets from.")
...
class SubstringMatchCriteria(BaseModel):
    ...
    text: Optional[str] = Field(description="The text to search for in the document.")
...
class TableRange(BaseModel):
    ...
    row_span: Optional[int] = Field(description="The row span of the table range.")
...
class InsertTableRequest(BaseModel):
    ...
    rows: Optional[int] = Field(description="The number of rows in the table.")
    columns: Optional[int] = Field(description="The number of columns in the table.")
    location: Optional[Location] = Field(
        description=(
...
class Request(BaseModel):
    ...
    update_table_column_properties: Optional[UpdateTableColumnPropertiesRequest] = (
        Field(description="Updates the properties of columns in a table.")
    )
